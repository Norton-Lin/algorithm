...
public class Solution{
	public static void main(String args[]) {
		MajorityChecker sChecker = new MajorityChecker(new int[] {1,1,2,2,1,1,});
		int ans = sChecker.query(0, 5, 4);
	}
}
/**
